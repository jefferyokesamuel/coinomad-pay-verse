...
const Trust = () => {
  ...
  return (
    <section className="py-20 bg-black" id="partners">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Trusted by Crypto Founders and DAOs</h2>
          <p className="text-coinomad-textGray text-lg max-w-2xl mx-auto">
            Join hundreds of projects that rely on Coinomad for their crypto payroll needs.
          </p>
        </div>
